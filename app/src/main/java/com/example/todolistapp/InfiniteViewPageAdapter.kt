...
class InfiniteViewPageAdapter(fragmentManager: FragmentManager) :
    ...
    override fun getItem(position: Int): Fragment {
        ...
        val dateForMonth = baseDate.plusMonths(offset.toLong())
        return MonthFragment.newInstance(dateForMonth)
    }
